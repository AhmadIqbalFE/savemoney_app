...
export default function Navbar({ navItems, activeNav, setActiveNav }) {
  ...
  return (
    <div
      ...
      } px-2 pt-3 pb-6 flex justify-around z-10`}
    >
      {navItems.map((item, i) => (
        <button
          key={i}
        ...
        >
          {i === 2 ? (
            <div
              className={`w-12 h-12 bg-sky-600 rounded-2xl flex items-center justify-center -mt-6 shadow-lg ${
                darkMode ? "shadow-sky-500" : "shadow-sky-300"
              }`}
            >
