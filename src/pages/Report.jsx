import { faArrowTrendUp, faArrowTrendDown, faWallet, faRobot, faArrowRight, } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className={`min-h-screen ${darkMode ? "bg-stone-950" : "bg-stone-50"} flex justify-center`}>
      <div className="w-full max-w-md pb-24">
        ...
        <div className="mx-4 mt-4 grid grid-cols-2 gap-3">
          ...
          {/* Income */}
          <div className={`${darkMode ? "bg-emerald-500" : "bg-emerald-100"} rounded-2xl p-4 shadow-sm ring-1 ${darkMode ? "ring-emerald-700" : "ring-emerald-300"}`}>
            <div className={`w-10 h-10 rounded-xl ${darkMode ? "bg-emerald-200" : "bg-emerald-50"} flex items-center justify-center mb-3`}>
              <FontAwesomeIcon icon={faArrowTrendUp} className="text-emerald-500"/>
            </div>
            <p className={`text-xs ${darkMode ? "text-white" : "text-olive-700"} mb-1`}>
              Income
            </p>
          ...
          {/* Expense */}
          <div className={`${darkMode ? "bg-rose-700" : "bg-rose-50"} rounded-2xl p-4 shadow-sm ring-1 ${darkMode ? "ring-rose-700" : "ring-rose-300"}`}>
            <div className={`w-10 h-10 rounded-xl ${darkMode ? "bg-rose-200" : "bg-rose-50"} flex items-center justify-center mb-3`}>
          ...
          <div className={`${darkMode ? "bg-gradient-to-br from-cyan-900 to-stone-900" : "bg-gradient-to-br from-cyan-500 to-blue-600"} rounded-2xl p-5 text-white`}>
            ...
            <div className="bg-white/10 rounded-xl p-3">
              ...
              <div className="h-2 bg-white/20 rounded-full overflow-hidden">
                <div className="h-full bg-white rounded-full" style={{ width: `${savingPercent}%` }}/>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-4 mt-5">
          <div className={`${darkMode ? "bg-stone-900" : "bg-white"} rounded-2xl p-4 shadow-sm ring-1 ${darkMode ? "ring-stone-800" : "ring-stone-100"}`}>
            <div className="mb-4">
              <p className={`text-xs font-semibold ${darkMode ? "text-stone-50" : "text-stone-400"} uppercase tracking-wide`}>
                Expense Graphic
              </p>

              <h2 className={`text-lg font-bold ${darkMode ? "text-red-700" : "text-red-400"} mt-1`}>
                Expense Trend
              </h2>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className={`text-xs ${darkMode ? "text-stone-100" : "text-blue-700"} leading-relaxed`}>
                  Pengeluaran hiburan naik 18% dibanding bulan lalu.
                  Namun tabungan kamu masih stabil dan berada
                  di atas target minimum bulanan.
                </p>
              </div>
            </div>
          </div>
