          ...
          >
                  ...
                  <div className="flex flex-col items-center">
                    <div
                      className={`w-10 h-10 rounded-xl ${
                        darkMode ? "bg-rose-200" : "bg-rose-100"
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full ${
                  darkMode ? "bg-stone-900" : "bg-yellow-50"
                } border ${
                  darkMode
                    ? "border-stone-800 text-white placeholder:text-stone-500"
                    : "border-yellow-200 text-stone-900 placeholder:text-stone-400"
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full ${
                    darkMode ? "bg-stone-900" : "bg-green-50"
                  } border ${
                    darkMode
                      ? "border-stone-800 text-white placeholder:text-stone-300"
                      : "border-green-200 text-stone-900 placeholder:text-stone-400"
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                {categories.map((cat) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-2xl ${cat.color} flex items-center justify-center mx-auto mb-2`}
                    >
                      <FontAwesomeIcon
                        icon={cat.icon}
                        className={`text-lg ${cat.iconColor}`}
                      />
                    </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full dark:scheme-dark ${
                  darkMode ? "bg-stone-900" : "bg-blue-50"
                } border ${
                  darkMode
                    ? "border-stone-800 text-white placeholder:text-stone-300"
                    : "border-blue-200 text-stone-900 placeholder:text-stone-400"
                } rounded-xl px-4 py-3 text-sm outline-none ${
                  darkMode ? "focus:border-stone-700" : "focus:border-blue-400"
                } cursor-pointer`}
              />
            </div>
            ...
            <div className="mb-6">
              <label
                className={`text-xs font-semibold ${
                  darkMode ? "text-stone-200" : "text-stone-400"
                } uppercase tracking-wide mb-2 block pt-3`}
              >
                {t.note}
              </label>
              ...
              <textarea
                ...
                className={`w-full ${
                  darkMode
                    ? "bg-stone-900 border-stone-800 focus:border-stone-700 text-white placeholder:text-stone-300"
                    : "bg-indigo-50 border-indigo-200 focus:border-indigo-400 text-stone-900 placeholder:text-stone-400"
                } border rounded-xl px-4 py-3 text-sm outline-none resize-none`}
              />
            </div>
            ...
            <button
              ...
              } rounded-2xl py-4 text-white font-semibold shadow-lg`}
            >
